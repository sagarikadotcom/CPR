    ...
    return(
        <Grid container className={props.classes.mainGridContainer}>
            <div className={props.classes.textContainer}>
                ...
                <Typography className={props.classes.textItem}><GoPrimitiveDot/> Limited seats available and admissions are subject to first come first serve basis, registrations close on 10th February 2023 irrespective of the number of seats available.</Typography>
                ...
                <Typography className={props.classes.textItem}><GoPrimitiveDot/> Boarding charges shall be applicable if you keep the dog at the facility- Rs.350 for day boarding and Rs.750 for night boaring</Typography>
                ...
                <Typography className={props.classes.textItem}><GoPrimitiveDot/> Payment details: 50%(Rs.35,000) for registration and 100% payment has to be done by 10th February 2023.(Amount paid is non-refundable and non-transferable)</Typography>
