    ...
    return(
        <Grid container className={props.classes.mainGridContainer}>
            <div className={props.classes.textContainer}>
                ...
                <Typography className={props.classes.textItem}><GoPrimitiveDot/> Limited seats available and admissions are subject to first come first serve basis, registrations close on 15th February 2023 irrespective of the number of seats available.</Typography>
                ...
                <Typography className={props.classes.textItem}><GoPrimitiveDot/> Payment details: 5000 for registration (non -refundable)100% payment has to be done by 15th February 2023. (refundable if cancelled).</Typography>
                <Typography className={props.classes.textItem}><GoPrimitiveDot/> We encourage you to bring your own dog for the workshop for hands-on training sessions, if not possible, Team CPR shall try and provide a dog subject to availability.</Typography>
                        </div>
